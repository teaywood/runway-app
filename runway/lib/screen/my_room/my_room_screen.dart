...
import 'closet/avatar_closet_screen.dart';
import 'trophy/trophy_room_screen.dart';
import 'widgets/room_action_buttons.dart';
import 'widgets/room_avatar_viewer.dart';

/// 마이룸 메인 화면
///
/// 책임:
///  - Scaffold 및 런웨이 공간감 배경(Gradient + Soft Light) 구성
///  - 아바타 뷰어 / 액션 버튼 레이어 조립 및 네비게이션 라우팅
class MyRoomScreen extends StatelessWidget {
  ...
  void _openCloset(BuildContext context) {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (_) => const AvatarClosetScreen()),
    );
  }

  void _openTrophyRoom(BuildContext context) {
    Navigator.push(
      context,
